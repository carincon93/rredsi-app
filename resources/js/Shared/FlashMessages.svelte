...
{#if showSuccessMessage && successMessage}
    <div
        class="ml-20 mb-8 flex items-center justify-between bg-green-500 rounded max-w-md fixed -bottom-0 z-index-full"
        transition:fly={{
            delay: 250,
            duration: 300,
            x: 100,
...
{#if (showErrorMessage && errorMessage) || (Object.keys(errors).length > 0 && showErrorMessage)}
    <div
        class="ml-20 mb-8 flex items-center justify-between bg-red-500 rounded max-w-3xl fixed -bottom-0 z-index-full"
        transition:fly={{
            delay: 250,
            duration: 300,
            x: 100,
