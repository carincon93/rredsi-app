...
<InfoMessage class="mt-20">
    Si aún no tiene cuenta puede crear una diligenciando el siguiente <a use:inertia href={route('register', 'tipoUsuario=estudiante')} class="text-gray-500 underline">formulario</a>
</InfoMessage>
