...
<form on:submit|preventDefault={submit} class="col-span-2">
    <fieldset class="px-8" disabled={isSuperAdmin || checkPermission(authUser, [29]) ? undefined : true}>
        <div class="mt-4">
            <div>
            ...
            <div class="mt-4">
                <Label required={method == 'put' ? undefined : 'required'} labelFor="imagen" value="Imagen" />
                        ...
                        <div class="space-y-1 text-center">
                            ...
                            <div class="flex text-sm text-gray-600">
                                <label for="image" class="relative cursor-pointer bg-white rounded-md font-medium text-indigo-600 hover:text-indigo-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
                                    ...
                                    <input id="image" bind:value={$form.image} type="file" accept=".png,.jpg,.jpeg" class="sr-only" on:change={(event) => loadfile(event)} required={method == 'put' ? undefined : 'required'} />
                                </label>
                            </div>
